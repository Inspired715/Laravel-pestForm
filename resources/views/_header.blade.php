<header class="bg-white shadow px-4 mb-8 md:mb-10 py-3 lg:py-0">
    <!-- navbar -->
    <nav x-data="{ open: false }" class="max-w-7xl mx-auto flex items-center justify-between relative w-full z-10">
        <a class="flex items-center leading-none" href="{{route('homepage')}}">
            <svg class="fill-current h-8 mr-4 w-8 text-brand-primary-500 sm:h-12 sm:w-12"
        ...
        <ol class="absolute w-full bg-white shadow top-16 z-50 lg:-mx-0 lg:bg-transparent lg:flex lg:items-center lg:mt-0 lg:shadow-none lg:static lg:w-auto lg:font-bold py-5 lg:py-0"
            x-bind:class="open ? '' : 'hidden'">
            <li>
                <a class="border-b-2 border-brand-gray lg:border-transparent inline-block w-full lg:w-auto px-3 lg:px-0 lg:mx-6 py-3 lg:py-6 transition-all ease-linear lg:hover:border-brand-primary-300"
            ...
            <li>
                <a class="border-b-2 border-brand-gray lg:border-transparent inline-block w-full lg:w-auto px-3 lg:px-0 lg:mx-6 py-3 lg:py-6 transition-all ease-linear lg:hover:border-brand-primary-300"
                    href="{{route('docs.index')}}"> Docs </a>
            </li>
            <li>
                <a class="border-b-2 border-transparent inline-block w-full lg:w-auto px-3 lg:px-0 lg:mx-6 py-3 lg:py-6 transition-all ease-linear lg:hover:border-brand-primary-300"
