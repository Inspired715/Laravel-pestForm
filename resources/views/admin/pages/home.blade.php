                ...
                <div class="row">
                        ...
                        <div class="card card-widget widget-user-2">
                            ...
                            <div class="widget-user-header bg-warning">
                                <div class="widget-user-image">
                                    <img class="img-circle elevation-2" src="{{asset('/images/user7-128x128.jpg')}}"
                                        alt="User Avatar">
                                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-image">
                                <img class="img-circle elevation-2" src="{{asset('/images/user1-128x128.jpg')}}"
                                    alt="User Avatar">
                            </div>
                            <div class="card-footer">
                                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-widget widget-user">
                            ...
                            <div class="widget-user-image">
                                <img class="img-circle" src="{{asset('/images/user3-128x128.jpg')}}" alt="User Avatar">
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-sm-4 border-right">
                        ...
                        <div class="card card-widget">
                            <div class="card-header">
                                <div class="user-block">
                                    <img class="img-circle" src="{{asset('/images/user1-128x128.jpg')}}" alt="User Image">
                            ...
                            <div class="card-footer card-comments">
                                <div class="card-comment">
                                    ...
                                    <img class="img-circle img-sm" src="{{asset('/images/user3-128x128.jpg')}}" alt="User Image">
                                ...
                                <div class="card-comment">
                                    ...
                                    <img class="img-circle img-sm" src="{{asset('/images/user4-128x128.jpg')}}" alt="User Image">
                                    <div class="comment-text">
                                        <span class="username">
                                            Luna Stark
                                            <span class="text-muted float-right">8:03 PM Today</span>
                            ...
                            <div class="card-footer">
                                <form action="#" method="post">
                                    <img class="img-fluid img-circle img-sm" src="{{asset('/images/user4-128x128.jpg')}}"
                                        alt="Alt Text">
                        ...
                        <div class="card card-widget">
                            ...
                            <div class="card-body">
                                ...
                                <div class="attachment-block clearfix">
                                    <img class="attachment-img" src="{{asset('/images/photo1.png')}}" alt="Attachment Image">
                            ...
                            <div class="card-footer card-comments">
                                ...
                                <div class="card-comment">
                                    ...
                                    <img class="img-circle img-sm" src="{{asset('/images/user5-128x128.jpg')}}" alt="User Image">
                                    <div class="comment-text">
                                        <span class="username">
                                            Nora Havisham
                                            <span class="text-muted float-right">8:03 PM Today</span>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2 bg-gradient-dark">
                                    <img class="card-img-top" src="{{asset('/images/photo1.png')}}" alt="Dist Photo 1">
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2">
                                    <img class="card-img-top" src="{{asset('/images/photo2.png')}}" alt="Dist Photo 2">
                            ...
                            <div class="col-md-12 col-lg-6 col-xl-4">
                                <div class="card mb-2">
                                    <img class="card-img-top" src="{{asset('/images/photo3.jpg')}}" alt="Dist Photo 3">
